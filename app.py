...
app.config ['SQLALCHEMY_DATABASE_URI'] = "postgresql://iggtadvtdnuerw:ace15b7e0ea69bc94dd403d263edc7fcbda57b223466e2f0fabf58626c0b6653@ec2-52-204-157-26.compute-1.amazonaws.com:5432/d1jqnudo5rrc6e"
...
def home():   
     db.create_all() 
     c=contacts.query.filter_by().all()
